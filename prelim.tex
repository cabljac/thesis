...
\begin{lemma}[{\cite[theorem...?]{datar2016kahler}}] \label{lem:nonprodDF} Let \((\X,\L,v')\) be the special test configuration of \(X\) corresponding to the polytope \(\Delta_y\) and the element \(v' = (-v,1) \in N'\), as in Theorem~\ref{thm:iltensueskstab}. Then:
\[
