...
\definecolor{mycyan}{RGB}{42,161,152}
\definecolor{myorange}{RGB}{203,75,22}
...
\fill[fill=mycyan,opacity=0.8] (3.95,-3.22) -- (-4.499,-0.465) -- (-4.021,1.710) -- (3.801,3.946) -- (9.206,2.697) -- (7.162,-1.310) -- cycle;
\draw [] (-4.499,-0.465)-- (-4.021,1.710);
\draw [] (-4.021,1.710)-- (3.801,3.946);
\draw [] (-4.499,-0.465)-- (3.95,-3.22);
\draw [] (2.437,0.786)-- (-16.628,-10.065);
\draw [] (3.95,-3.22)-- (-4.499,-0.465);
\draw [] (-4.499,-0.465)-- (-4.0213,1.710);
\draw [] (-4.0213,1.710)-- (3.801,3.946);
\draw [] (3.801,3.946)-- (9.206,2.697);
\draw [] (9.206,2.697)-- (7.162,-1.310);
\draw [] (7.162,-1.310)-- (3.95,-3.22);
\draw [] (-4.499,-0.465)-- (-6.070,-0.590);
\draw [,domain=-8.693:12.217] plot(\x,{(-7.125-1.570*\x)/0.124});
\draw [] (-0.274,-1.842)-- (-0.623,-2.911);
...
\draw (-7.6,4) node[anchor=north west] {$\Pi(w,a)$};
\draw [->,line width=0.05pt] (-0.274,-1.842) -- (-0.623,-2.911);
\draw [->,line width=0.05pt] (-4.499,-0.465) -- (-6.070,-0.590);
