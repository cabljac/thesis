...
\begin{subfigure}[b]{0.25\linewidth}
	\centering
 	 \begin{tikzpicture}[scale=1]
 	 \draw[dotted,step=1,gray] (0,-2) -- (0,2);
 	 \draw[line width = 1.2pt] (0,-1) -- (0,1);
 	 \draw (0,0) node {\textbullet};
 	 \draw (0,-1) node {\tiny{\textbullet}};
 	 \draw (0,1) node {\tiny{\textbullet}};
 	 \node at (0,-1) [left] {\tiny{$\Gamma_{11}$}};
 	 \node at (0,1) [left] {\tiny{$\Gamma_{12}$}};
 	 \node at (0,0) [right,red] {{$\Gamma_1$}};
 	 \draw[->] (0,0) -- (0,2);
 	 \node at (0,2) [above] {{$\lambda$}};
	\end{tikzpicture}
\end{subfigure}
\begin{subfigure}[b]{0.25\linewidth}
	\centering
